export default {
  site: {
    title: "Communication Engineering Research",
    description: "Searchable Communication Engineering research repository",
    baseUrl: "/",
    language: "en",
    siteUrl: "https://communication.echelonfoundry.com/",
  },
  repository: {
